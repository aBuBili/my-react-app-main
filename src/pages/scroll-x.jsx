...
function Scroll({ ScrollBox, move }) {
    ...
    return (
      <Row style={{ flexWrap: "nowrap" }}>
        {["A", "B", "C", "D", "E", "F", "G", "H"].map((item, k) => {
          return (
            <Col key={k}>
              <div className={item == selected ? "item active" : "item"} onClick={() => setSelected(item)}>
                {item}
              </div>
            </Col>
          );
      ...
      <div className="container">
        <TabStyled>
          <Row>
            <Col>
              <div
                className={tabIndex == 1 ? `tab-left-active tab-item` : `tab-left-default tab-item`}
            ...
            <Col>
              <div
                className={tabIndex == 2 ? `tab-right-active tab-item` : `tab-right-default tab-item`}
